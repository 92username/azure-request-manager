...
SIMULATED_ERRORS_500 = Counter('azure_request_error_500', 'Number of simulated 500 errors')
REQUEST_DURATION = Histogram('azure_request_duration_seconds', 'Request duration in seconds')
    ...
    try:
        ...
        if should_simulate_failure(failure_rate):
            ...
            if mode == "timeout":
                ...
                return {"success": False, "status_code": 500, "error": "Simulated 500 error"}
